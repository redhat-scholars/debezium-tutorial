...
85198a7a8c97  quay.io/debezium/example-mysql:2.6        mysqld                14 seconds ago  Up 10 seconds  0.0.0.0:3306->3306/tcp  mysql
808a633208b7  quay.io/debezium/connect:2.6              start                 12 seconds ago  Up 9 seconds   0.0.0.0:8083->8083/tcp  connect
